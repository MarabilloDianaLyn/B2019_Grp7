namespace AI_TaskM.Migrations
{
    ...
    public partial class maintask1 : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.MainTasks", "User_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.ToDoes", "TaskId", "dbo.MainTasks");
            ...
            DropIndex("dbo.ToDoes", new[] { "TaskId" });
